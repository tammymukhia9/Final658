...
class StoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create story" do
    assert_difference('Story.count') do
      post stories_url, params: { story: { description: @story.description, name: @story.name } }
    end
  ...
  test "should update story" do
    patch story_url(@story), params: { story: { description: @story.description, name: @story.name } }
